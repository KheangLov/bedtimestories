          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="card card-tasks">
                ...
                <div class="card-body">
                  <form action="category.php?id=<?php echo $cate_id; ?>" method="post">
                    ...
                    <div class="form-group text-right">
                      <input type="submit" name="<?php echo $cate_id == '' ? 'add' : 'edit'; ?>_cate" class="btn btn-<?php echo $cate_id == '' ? 'primary' : 'info'; ?> btn-sm" value="<?php echo $cate_id == '' ? 'Add' : 'Edit'; ?>">
                    </div>
                  </form>
                </div>
              </div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                ...
                                <td class="td-actions">
                                  <a href="category.php?<?php echo "id={$cates['id']}"; ?>" class="btn btn-info">
                                    <i class="fa fa-pencil"></i>
                                  </a>
                                  <a href="#" onClick="deleteCate(<?php echo $cates['id']; ?>)" class="btn btn-danger">
